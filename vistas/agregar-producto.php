...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $controlador->agregarProducto($_POST);
}
?>
...
<body>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form name="agregar_producto" onsubmit="return valida_formulario()" method="POST">
                                    <div class="form-group row">
                                        <label for="full_name" class="col-md-4 col-form-label text-md-right">Producto</label>
                                        <div class="col-md-6">
                                            <input type="text" id="producto" class="form-control" name="producto" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="full_name" class="col-md-4 col-form-label text-md-right">Descripción</label>
                                        <div class="col-md-6">
                                            <textarea type="text" id="descripcion" class="form-control" name="descripcion" rows="4"></textarea>
                                        </div>
                                    </div>                                    
                                    <div class="form-group row">
                                        <label for="full_name" class="col-md-4 col-form-label text-md-right">Valor</label>
                                        <div class="col-md-3">
                                            <input type="number" id="valor" class="form-control" name="valor" min="0">
                                        </div>
                                    </div>                                    
    ...
    <script src="../js/valida_agregar_usuario.js"></script>
</body>
