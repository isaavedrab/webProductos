    ...
    <div class="container">
        ...
        <container>
            ...
            foreach ($productos as $key => $producto) {
                ...
                echo
                '<div class="card">
                    <img src="../img/no_disponible.png" class="card-img-top" alt="...">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <div>                        
                            <span class="text-muted"><b>$' . $producto->valor . '</b></span>                                
                        </div>';
                        if(empty(!$_SESSION)){
                            echo
                            '<hr>
                            <div class="d-flex flex-row-reverse">
                                <a href="./procesar-producto.php?idproducto=' . $producto->idproducto . '" class="btn btn-primary">Comprar</a>                            
                            </div>';
                        }                      
                     echo  
                    '</div>                        
                </div>';
                if (fmod($key + 1, 5) == 0 && $key !== 0) {
                    echo '</div><br>';
                }
            }
            ?>
