...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    if (isset($_REQUEST['funcion'])) {
        ...
        if ($_REQUEST['funcion'] === 'eliminar') {
            $controlador->eliminarUsuario($_REQUEST['idusuario']);
        }
    }
}
...
<body>
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" id="table-usuario" style="width:100%;">
                <thead class="thead-dark">
                    <tr>
                        ...
                        <th colspan="3" style="text-align:right;">
                            <a href="./agregar-usuario.php" class="btn btn-primary">(+) Agregar</a>
                        </th>
                    </tr>
                    <tr>
                        <th scope="col" style="width:10%;">Usuario</th>
                        <th scope="col" style="width:25%;">Nombre Completo</th>
                        <th scope="col" style="width:15%;">RUT</th>
                ...
                <tbody>
                    <?php foreach ($usuarios as $usuario) {
                        ...
                        <td>' . $usuario->nombre . " " . $usuario->apepaterno . " " . $usuario->apematerno . '</td>
                        <td>' . $usuario->rut . '</td>
                        ...
                        <td>
                            <div class="row mx-0">
                                <div class="col-md-6 pr-0">                                                        
                                    <a href="./editar-usuario.php?idusuario=' . $usuario->idusuario . '" class="btn btn-primary">Editar</a>
                                </div>
